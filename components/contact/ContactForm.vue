<template>
    <div id="tl-contact-form" class="tl-form mt-4 mt-md-0">
      <form class="contact-form" @submit.prevent="onSubmit">
            ...
            <span class="form-control-wrap">
              <span class="wpcf7-form-control wpcf7-radio">
                <span class="wpcf7-list-item first">
                  <label>
                    <input v-model="form.interest" type="radio" name="interest" value="Branding" />
                ...
                <span class="wpcf7-list-item">
                  <label>
                    <input v-model="form.interest" type="radio" name="interest" value="Web Design" />
                ...
                <span class="wpcf7-list-item">
                  <label>
                    <input v-model="form.interest" type="radio" name="interest" value="App Design" />
                ...
                <span class="wpcf7-list-item last">
                  <label>
                    <input v-model="form.interest" type="radio" name="interest" value="Other" />
        ...
        <div>
          ...
          <!-- Inline status (keeps theme layout clean) -->
          <p v-if="success" class="mt-2" style="opacity: 0.9">
            ✅ Message sent. I'll get back to you soon.
          </p>
          <p v-else-if="errorMsg" class="mt-2" style="opacity: 0.9">
            ❌ {{ errorMsg }}
          </p>
        </div>
      </form>
  ...
  // Local form state (mirrors the API schema)
  const form = reactive({
    name: '',
    email: '',
    phone: '',
  ...
  async function onSubmit() {
    ...
    try {
      // Nuxt server endpoint: server/api/contact.post.ts
      ...
      // Prefer H3 error payload if present
      errorMsg.value =
        err?.data?.message ||
        err?.statusMessage ||
